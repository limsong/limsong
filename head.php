    ...
    <div class="header-middle hidden-sm hidden-xs hidden-md">
        <div class="container-fluid">
            <div class="row">
                 ...
                 * <div class="col-lg-2 no-padding">
                    <div class="left-category-menu hidden-sm  hidden-xs hidden-md">
                        <div class="left-product-cat">
                            <div class="category-heading no-padding">
                                <span>category</span>
                                <div class="cat-align">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    ...
                                    <li class=" rx-parent">
                                        <a class="rx-default">
                                            <span class="cat-thumb  fa fa-user"></span><!---fa-plus-->
                                            More categories
                                        </a>
                                        <a class="rx-show">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 no-padding-left">
                        ...
                        <div class="plus-account">
                            ...
                            <div class="plus-menu">
                                <ul>
                                    ...
                                    <li><a href="join_step1.php">회원가입</a></li>
                                    <?
                                    }
                                    ?>
                                </ul>    
                        ...
                        <div class="cart-wrapper">
                            ...
                            <div class="cart-drop">
                                ...
                                <div class="cart-sub-total">
                                    <p>sub total <span data-sum="0">₩0</span></p>
                                </div>
