...
$html = '<div class="row"><div class="col-md-12 no-padding"><div style="width:75px;position: relative;float: left;">';
//imagename
...
$html .= '<img src="' . $imgSrc . '" width="75" height="75"></div>'
    . '<div class="col-md-12" style="padding-top:10px;"><p style="margin:0px;">' . $goods_name . '</p><p class="free">무료배송</p></div>'
    ...
    . '<input type="hidden" class="goods_opt_type" value="' . $goods_opt_type . '">'
    . '<input type="hidden" class="optNum" value="' . $goods_opt_num . '">'
    ...
    . '<input type="hidden" value="' . $goods_code . '" class="code goods_code">'
    ...
    . '<div class="col-md-12 no-padding" style="max-height:450px;overflow: hidden;overflow-y:auto;">'
    . '<div class="col-md-12">'
    . '<div class="col-md-12 no-padding">'
...
if ($goods_opt_type != "0") {
    ...
    $html .= '<div class="col-md-12 m-item">
                <div class="col-md-12 cm12" style="padding:0px;margin-bottom: 30px;">
                    ...
                    <div class="col-md-6" style="padding:0px;line-height: 25px;">옵션없음11</div>
                    <div class="col-md-3 no-padding">
                        <div class="col-md-4" style="background-color:white;padding:0px;text-align:center;line-height:25px;height:25px;">
                        ...
                        <div class="col-md-4" style="background-color:white;padding:0px;text-align:center;">
...
$html .= '<!--PRODUCT INCREASE BUTTON START-->'
    ...
    . '<!-- 메인상품 추가 폼 시작-->'
    . '<div class="col-md-12 col-xs-12 m-item">'
...
for ($i = 0; $i < $sbcount; $i++) {
    ...
    $html .= '<div class="col-md-12 col-xs-12 no-padding">'
        ...
        . '<div class="col-md-6 cm12" style="line-height:25px;height:25px;">' . $goods_name . '</div>'
        ...
        . '<i class="fa fa-minus item-minus"></i>'
        . '</div>'
        . '<div class="col-md-4 cm4 no-padding" style="text-align:center;">'
...
//추가옵션 출력
$html .= '<div class="col-md-12 col-xs-12 s-item no-padding">';
if ($goods_opt_type != "0") {
    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        $html .= '<div class="col-md-12 col-xs-12 no-padding">'
            ...
            . '<div class="col-md-6 cm12" style="line-height:25px;height:25px;">' . $option_name . '</div>'
            . '<div class="col-md-3 cm6">'
            . '<div class="col-md-4 cm4" style="background-color:white;padding:0px;text-align:center;line-height:25px;height:25px;">'
            . '<i class="fa fa-minus item-minus"></i>'
            . '</div>'
...
$html .= '</div>'
    ...
    . '<!-- 토탈 폼 시작-->'
    . '</div>'
    . '<div class="col-md-12 cm12 total" style="display:block;">'
