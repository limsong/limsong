                ...
                <div class="row">
                                        ...
                                        <div class="table-responsive cart-area-wrapper">
                                            <table class="table">
                                                ...
                                                if ($chkitem == "") {
                                                    ...
                                                    $_SESSION["goods_code"] = $goods_code;
                                                    $_SESSION["sbnum"]="";
                                                    $_SESSION["sbid"] = "";
                                                    $_SESSION["opid"] = "";
                                                    $_SESSION["opnum"] = "";
                        ...
                        <div class="checkbox-form">
                            ...
                            <h3 class="col-md-12" style="margin:0px;padding-left:0px;border-bottom:none;margin-top:20px;">
                                ...
                                <div style="font-size:12px;" class="col-md-9">
                                    <input type="radio" name="addr_type" class="addr_type" id="addr_type0" style="margin-left:10px;">
                                    ...
                                    <table class="table borderless user-info">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <div class="input-group-btn">
                                                                    <button type="button" class="btn btn-default" data-toggle="dropdown" aria-expanded="false" style="border-right: none;">
                                                                ...
                                                                <input type="text" name="phone2" class="form-control phone2" style="margin:0px;width:50%;border-right:none;">
                                                                <input type="text" name="phone3" class="form-control phone3" style="margin:0px;width:50%;">
                                                            </div>
                                                            <!-- /input-group -->
                                                        </div>
                                                        <!-- /.col-lg-6 -->
                                                ...
                                                <div class="checkout-form-list">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" readonly="readonly" name="zipcode" id="zipcode" style="margin:0px;">
                                                                    <span class="input-group-btn">
                                                                        <button type="button" class="btn btn-red" onclick="javascript:DaumPostcode('zipcode','add1','add2');">
                                                                            우편번호찾기
                                                                        </button>
                                                                    </span>
                                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="checkout-form-list">
                                                    <div class="col-md-12">
                                                        <input type="text" name="ship_message" class="ship_message" type="hidden">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="your-order-table table-responsive">
                                <table class="table checkout-table checkout" style="border-top:2px solid #666;">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <span class="checkout-price"><?= number_format($total_sum * $sb_sale + $total_sum2 + $total_dShipping) ?></span>
                                            <span class="won2">원
                                            </span>
                                        </td>
                                    </tbody>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="your-order">
                            ...
                            <input type="hidden" name="acceptmethod" value="SKIN(#E26A6A):HPP(1):no_receipt:va_receipt:vbanknoreg(0):vbank(<?= $offer_date_last ?>):below1000">
                            ...
                            <?php
                            $_SESSION["buy_instant_discount"] = "";//상품 즉시할인 금액(총 할인금액)
                            $_SESSION["buy_total_price"] = "";//총상품총액(할인전금액)
                            $_SESSION["pay_dlv_fee"] = "";//결제한 배송비

                            $_SESSION["buy_instant_discount"] = $total_sum - $total_sum * $sb_sale;//상품 즉시할인 금액(총 할인금액)
                            $_SESSION["buy_total_price"] = $total_sum + $total_sum2;//총상품총액(할인전금액)
                            $_SESSION["pay_dlv_fee"] = $total_dShipping;
