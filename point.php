                ...
                <div class="col-md-3 col-lg-2">
                    <div class="small-cat-menu">
                        <ul class="cat-menu-ul">
                            ...
                            <li class="cat-menu-li"><a class="active" href="point.php">적립금현황</a></li>
                            ...
                            <div class="row cart-top">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <div class="col-md-12" style="margin: 0px 0px 5px 0px;padding:0px;">* 적립금 보유내역입니다.</div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="txt_ag_left">
                                                        적립된 금액이 1,000,000원 이상 누적되었을 때, 사용하실 수 있습니다.<br>
                                                        결재시 적립금 사용여부를 확인하는 안내문이 나옵니다.<br>
                                    ...
                                    <div class="table-responsive">
                                        <div class="col-md-12" style="margin: 20px 0px 5px 0px;padding:0px;">* 적립금 사용내역입니다..</div>
                                        <table class="table table-bordered">
                                            <thead>
                                              <tr>
                                                <td width="15%">적립날짜</td>
