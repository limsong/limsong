...
<body class="home-2">
        ...
        <section class="category-area-one control-car mar-bottom">
                                                                                                                                ...
                                                                                                                                if ($j == 0) {
                                                                                                                                        ...
                                                                                                                                        <td rowspan="<?= $cbuy_goods ?>" class="cart-total-price">
                                                                                                                                                ...
                                                                                                                                                if ($buy_goods_status < 2) {
                                                                                                                                                        ...
                                                                                                                                                        echo '<p><button type="button" class="btn btn-xs btn-default waves-effect waves-light bbs" data="goods_review"  goods-seq="' . $goods_id . '" buy-goods-seq="' . $buy_goods_seq . '">구매후기</button></p>';
                                                                                                                                                        echo '<p><button type="button" class="btn btn-xs btn-default waves-effect waves-light bbs" mod="' . $mod . '" data="goods_qna" goods-seq="' . $goods_id . '" buy-goods-seq="' . $buy_goods_seq . '">상품문의</button></p>';
                ...
                <!-- Modal -->
                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="display: none;">Launch demo modal
                </button>
