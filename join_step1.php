				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
						<div class="top-message">
							<h4>Deal : of the day <span>sozo ?</span> </h4>
						</div>
					</div>
								...
								<ul>
									<li><a href="index.html">Home</a>
										<ul class="sub-menu">
											...
											<li><a href="index-2-box.html">Homepage 2 box</a></li>
										</ul>
									</li>
									...
									<li><a href="">Pages</a>
										<ul class="sub-menu">
											...
											<li><a href="about-box.html">About us box</a></li>
										</ul>
									</li>
									<li><a href="portfolio.html">Portfolio</a>
										<ul class="sub-menu">
											<li><a href="portfolio-box.html">Portfolio box</a>
											<li><a href="portfolio-three-col.html">three columns</a></li>
											<li><a href="single-project.html">single project</a></li>  
											<li><a href="portfolio-three-col-box.html">three columns box</a></li>
											<li><a href="single-project-box.html">single project box</a></li> 
										</ul>
									</li>
						...
						<div class="top-right-menu-wrapper">
							...
							<ul>
								...
								<li class="dropdown">
									...
									<span>english</span> <i class="fa fa-angle-down"></i></a>
							...
							<div class="cart-drop">
								<div class="single-cart">
									<div class="cart-img">
									   <img src="img/cart-drop.jpg" alt="">
									   <span>2</span>
									</div>
									<div class="cart-title">
										<p><a href="">aeniuyt estuc</a></p>
									</div>
						...
						<div class="mobile-menu ">
							<nav class="mobile-menu-start">
								<ul>
										...
										<ul>
											<li><a href="">shop layout</a>
												<ul>
													...
													<li><a href="shop-box.html">shop grid view box</a></li>
													<li><a href="shop-list-box.html">shop List View box</a></li>
												</ul>
											</li>
											<li><a href="">shop pages</a>
												<ul>
													...
													<li><a href="checkout-box.html">Checkout</a></li>
													<li><a href="product-box.html">product page box</a></li>
													<li><a href="cart-box.html">Shopping Cart box</a></li>
													<li><a href="checkout-box.html">Checkout box</a></li>
												</ul>
											</li>
											<li><a href="">product types</a>
												<ul>
													...
													<li><a href="product.html">grouped product</a></li>
													<li><a href="product.html">external product</a></li>
													<li><a href="product.html">downloadable</a></li>
													<li><a href="product.html">virtual product</a></li>
												</ul>
											</li>
										</ul>
									</li>
									<li><a href="blog.html">blog</a>
										<ul>
											<li><a href="#">blog full width</a>
												<ul>
													<li><a href="blog.html">non sidebar</a></li>
													<li><a href="blog-left-sidebar.html">Sidebar Left</a></li>
													<li><a href="blog-right-sidebar.html">Sidebar Right</a></li>
												</ul>
											</li>
											<li><a href="blog-box.html">blog box layout</a>
												<ul>
													<li><a href="blog-box.html">non sidebar box</a></li>
													<li><a href="blog-left-sidebar-box.html">Sidebar Left box</a></li>
													<li><a href="blog-right-sidebar-box.html">Sidebar Right box</a></li>
												</ul>
											</li>
											<li><a href="">post format</a>
												<ul>
													<li><a href="single-post.html">image product</a></li>
													<li><a href="single-post-video.html">video product</a></li>
													<li><a href="single-post-gallery.html">gallery product</a></li>
													<li><a href="single-post-audio.html">audio product</a></li>
												</ul>
											</li>
										</ul>
									</li>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="coupon-accordion">
					<div class="col-lg-6 col-md-6" style="margin :0 auto;float:none;">
						<div class="checkbox-form">                     
							<div class="row" style="margin:0px;border-top:5px solid #ddd;border-bottom:5px solid #aaa;padding-left:10px;">
								<div class="col-lg-12 col-md-12" style="height:350px;overflow: hidden;overflow-y:scroll;padding-left:0px;">
									<h2>BLUE START 쇼핑몰 이용 약관</h2>
									  <b>제1조(목적)</b><br>
									  이 약관은 이지솔라 (전자상거래 사업자)가 운영하는 BLUE START 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리/의무 및 책임사항을 규정함을 목적으로 합니다.
									  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

									  <br><br><b>제2조(정의)</b>
									  ①“몰” 이란 이지솔라이 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
									  ②“이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br>
									  ③ ‘회원’이라 함은 “몰”에 개인정보를 제공하여 회원등록을 한 자로서, “몰”의 정보를 지속적으로 제공받으며, “몰”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.<br>
									  ④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.

									  <br><br><b>제3조 (약관등의 명시와 설명 및 개정)</b>
									  ...
									  <br><br><b>제6조(회원가입)</b>
										...
										④ 회원은 제15조제1항에 의한 등록사항에 변경이 있는 경우, 즉시 전자우편 기<br>타 방법으로 “몰”에 대하여 그 변경사항을 알려야 합니다.<br>

										<br><b>제7조(회원 탈퇴 및 자격 상실 등)</b>
										...
										회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.
										...
										① “몰”은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다. <br>다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.<br>
										...
										<br><br><b>제12조(수신확인통지?구매신청 변경 및 취소)</b>
										...
										<br><br><b>제13조(재화등의 공급)</b>
										① “몰”은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배
										송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.<br>
										...
										<br><br><b>제19조(회원의 ID 및 비밀번호에 대한 의무)</b>
										① 제17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.<br>
										② 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.<br>
										③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 “몰”에 통보하고 “몰”의 안내
										가 있는 경우에는 그에 따라야 합니다.

										<br><br><b>제20조(이용자의 의무)</b>
										...
										<br><br><b>제21조(연결“몰”과 피연결“몰” 간의 관계)</b>
										...
										부 칙(시행일) 이 약관은 2010년 8월 1일부터 시행합니다. 
							...
							<div class="col-md-12" style="padding:0px;">
								<label for="che1">
									<INPUT type="radio" name="join_step1_check" id="che1" value="o">
										이용약관에 동의 합니다.
								</label>
								<label for="che2">
									<INPUT type="radio" name="join_step1_check" id="che2" value="x">
										이용약관에 대하여 동의안합니다.
								</label>
							</div>
							<div class="col-md-6" style="padding:0px;">
									<div class="checkout-form-list">
										...
										<div class="order-button-payment">                                 
											<input type="button" value="회원가입" style="height:42px;margin:0px;" class="join_step1_sb">
										</div>
									</div>
								</div>
								<div class="col-md-6" style="padding:0px;">
									<div class="checkout-form-list">
										<label> <span class="required">&nbsp;</span></label>     
										<div class="order-button-payment">                                 
											<input type="button" onclick="javascript:location.href='index.php'" value="취소" style="height:42px;margin:0px;background-color:#6e6e6e;">
										</div>
									</div>
								</div>                                                 
						</div>
