        ...
        <div class="container-fluid">
            ...
            <div class="row" style="margin-bottom:60px;">
                <div class="coupon-accordion">
                    <div class="col-lg-12 col-md-12" style="margin :0 auto;float:none;margin-top:20px;">
                        <div class="checkbox-form">
                            <div class="row" style="margin:0px;padding-left:10px;background-color:#fff;">
                                <div class="col-lg-12 col-md-12" style="height:800px;overflow: hidden;overflow-y:scroll;padding-left:0px;">
                                    <b>제1조(목적)</b>
                                    <br>
                                    이 약관은 이지솔라 (전자상거래 사업자)가 운영하는 BLUE START 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리/의무 및 책임사항을 규정함을 목적으로 합니다. ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

                                    <br>
                                    <br>
                                    <b>제2조(정의)</b>
                                    ①“몰” 이란 이지솔라이 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                                    <br>
                                    ...
                                    <br>
                                    ③ 회원가입계약의 성립시기는 “몰”의 승낙이 회원에게 도달한 시점으로 합니다. ④ 회원은 제15조제1항에 의한 등록사항에 변경이 있는 경우, 즉시 전자우편 기
                                    <br>
                                    타 방법으로 “몰”에 대하여 그 변경사항을 알려야 합니다.
                                    <br>
                                    ...
                                    <br>
                                    <b>제13조(재화등의 공급)</b>
                                    ① “몰”은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배 송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.
                                    <br>
                                    ...
                                    <br>
                                    ③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 “몰”에 통보하고 “몰”의 안내 가 있는 경우에는 그에 따라야 합니다.
