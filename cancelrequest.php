                                                      ...
                                                      <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                  ...
                                                                  for ($i = 0; $i < $cbuy; $i++) {
                                                                        ...
                                                                        $db->query("SELECT buy_goods_seq,buy_goods_status,buy_goods_code,buy_goods_name,buy_goods_prefix,buy_goods_option,buy_goods_price,buy_goods_count,buy_goods_price_total,buy_goods_dlv_type FROM buy_goods WHERE buy_seq='$buy_seq' AND buy_goods_status<=4 OR buy_seq='$buy_seq' AND buy_goods_status='16' ");
