        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2">
                <div class="small-cat-menu">
                    <h2>
                        <a href="m_shop.php?code1=03&name1=<?= urlencode($sortName) ?>"><?= $sortName ?></a>
                    </h2>
                    <ul class="cat-menu-ul">
                        <?
                        $db->connect();
                        $db->query("SELECT sortName,sortCode FROM sortCodes WHERE uxCode='03' and umCode='00' ORDER BY sortOrder ASC");
            ...
            <div class="col-md-9 col-lg-10 no-padding">
                <div class="hidden-xs hidden-md hidden-sm col-lg-3">
                    <div class="single-banner">
                        ...
                        <p>
                            <a href="m_shop.php?code1=03&name1=<?= urlencode($sortName_first . $sortName_last) ?>">
