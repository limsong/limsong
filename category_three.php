			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-2">
					<div class="small-cat-menu">
                                                <h2><a href="shop.php?code3=01&name1=<?=urlencode($sortName)?>"><?=$sortName?></a></h2>
				...
				<div class="col-md-9 col-lg-10 no-padding">
					<div class="hidden-xs hidden-sm hidden-md col-lg-3">
							...
							<p>
								<a href="shop.php?code1=03&name1=<?=urlencode($sortName_first.$sortName_last)?>"><img src="<? echo $brandImagesWebDir.$dbdata[12]["imgName"] ?>" alt=""></a>
							</p>
						</div>
					</div>
