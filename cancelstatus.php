                                        ...
                                        <section class="cart-area-wrapper">
                                                <div class="container-fluid">
                                                        <div class="row cart-top">
                                                                <div class="col-md-12"><h3>*  취소/반품/교환 현황</h3></div>
                                                                <div class="col-md-12">
                                                                        <div class="table-responsive">
                                                                                <table class="table table-bordered">
                                                                                        ...
                                                                                        for ($i = 0; $i < $cbuy; $i++) {
                                                                                                ...
                                                                                                $buy_seq = $db_buy_claim[$i]["buy_seq"];//신청한 주문 일련번호
                                                                                        ...
                                                                                        $db->query("SELECT buy_claim_goods_seq,buy_claim_seq,buy_goods_req_seq,buy_goods_req_count,buy_goods_new_count FROM buy_claim_goods $buy_claim_goods");
                                                                                        ...
                                                                                        $db->query("SELECT goods_code FROM buy_goods $buy_goods_query");
                                                                                        $db_buy_goods = $db->loadRows();
                                                                                        $db_buy_goods_count = count($db_buy_goods);
                                                                                        for($i=0;$i<$db_buy_goods_count;$i++){
                                                                                                $goods_code = $db_buy_goods[$i]["goods_code"];
                                                                                                if($tmp_goods_code==""){
                                                                                                        $tmp_goods_code = $goods_code;
                                                                                                        $goods_query = "WHERE godos_code IN ('$goods_code'";
                                                                                                }else if($tmp_goods_code != $goods_code){
                                                                                                        $goods_query .= ",'$goods_code";
                                                                                                }
                                                                                        }
                                                                                        $goods_query .= ")";
                                                                                        ...
                                                                                        $tmp_goods_code = "0";
                                                                                        $db->query("SELECT goods_name,goods_opt_type,goods_opt_num FROM goods WHERE $goods_query");
                                                                                        $db_goods=$db->loadRows();
                                                                                        $cbuy_goods = count($db_goods);
                                                                                        FOR($j=0;$j<$cbuy_goods;$j++) {
                                                                                                $goods_opt_type = $db_goods[$i]["goods_opt_type"];
                                                                                                $goods_opt_num = $db_goods[$i]["goods_opt_num"];
                                                                                                $goods_name = $db_goods[$i]["goods_name"];
                                                                                                ?>
                                                                                                <tbody>
                                                                                                                        <tr>
                                                                                                                                <td>
                                                                                                                                ...
                                                                                                                                ?>
                                                                                                                                <td class="cart-total-price"><?=goods_status($buy_goods_status)?><br>(<? echo date("m-d",strtotime($pay_pre_date))?>이내)</td>
                                                                                                                                <?php
                                                                                                                                if($j==0) {
                                                                                                                                        ?>
