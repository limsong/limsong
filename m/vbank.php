...
if ($_POST['P_STATUS'] === '00') {
    ...
    if ($result['P_STATUS'] == '00' && (int)$cashmoney === (int)$result['P_AMT']) {
        ...
        $pay_online_account = vbankCode($P_VACT_BANK_CODE) . " | " . $P_VACT_NUM;//입금은행명 입금계좌
        $pay_pre_date = date("Y-m-d H:i:s", strtotime($P_VACT_DATE . $P_VACT_TIME));//입금예정일
