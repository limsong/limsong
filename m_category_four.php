                ...
                <div class="row">
                        ...
                        <div class="col-md-3 col-lg-2">
                                <div class="small-cat-menu">
                                        <h2>
                                                <a href="m_shop.php?code1=04&name1=<?= urlencode($sortName) ?>"><?= $sortName ?></a>
                                        </h2>
                        ...
                        <div class="col-md-9 col-lg-10 no-padding">
                                <div class="hidden-xs hidden-md hidden-sm col-lg-3">
                                        <div class="single-banner">
                                                ...
                                                <p>
                                                        <a href="m_shop.php?code1=04&name1=<?= urlencode($sortName_first . $sortName_last) ?>">
