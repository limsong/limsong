                  ...
                  <div class="row">
                                                      ...
                                                      for ($i = 0; $i < $count; $i++) {
                                                            ...
                                                            <li>
                                                                  <a href="#"
                                                                     ...
                                                                     data-update=""
                                                                     data-image="<?= $brandImagesWebDir . $db_upload_mimagesArr[$i]["ImageName"] ?>"
                                                                     data-zoom-image="<?= $brandImagesWebDir . $db_upload_bimagesArr[$i]["ImageName"] ?>">
                                                                        <img
                                                                              src="<?= $brandImagesWebDir . $db_upload_timagesArr[$i]["ImageName"] ?>"
                                                                              alt="zo-th-<?= $i ?>" />
                                                                  </a>
                                                            </li>
                                                            <?php
					  ...
					  *상품 정보 추가goods 시작
					   ...
					   */
                                          ...
                                          ?>
                                          <input type="hidden" value="<?= $db_goodsArr[0]["sellPrice"] ?>"
                                                 class="pric1">
                                          <input type="hidden" value="<?= $goods_code ?>" class="code">
                                          <input type="hidden" value="<?= $db_goodsArr[0]["goods_name"] ?>"
                                                 class="goods_name">
                                          ...
                                          <input type="hidden" name="goods_code" value="<?= $db_goodsArr[0]["goods_code"] ?>"
                                                 class="goods_code">
                                          <input type="hidden" value="<?= $db_goodsArr[0]["goods_opt_Num"] ?>"
                                                 class="optNum">
                                          <div class="prod-list-detail">
                                                <div class="prod-info">
                                                            ...
                                                            <div class="sin-post-info"
                                                                 style="padding:0px;margin:0px;">
                                                                  <div class="blog-meta-small no-margin">
                                                                        ...
                                                                        <span
                                                                              class="author">적립금 <?= number_format($goods_mile) . $goods_mile_flag ?></span>
                                                                  </div>
                                                                  ...
                                                                  <div class="blog-summary bd_bottom"
                                                      ...
                                                      if ($db_goodsArr[0]["goods_opt_type"] != "0") {
                                                            ...
                                                            <div class="col-md-12"
                                                                 style="border-bottom:1px dotted #aaa;margin:5px 0px 15px 0px;"></div>
                                                            <!-- 메인상품 추가 폼 시작-->
                                                            <div class="col-md-12 m-item"></div>
                                                            <!-- 메인상품 추가 폼 끝-->
                                                            <!-- 서브상품 추가 폼 시작-->
                                                            <div class="s-item"></div>
                                                            <!-- 서브상품 추가 폼 끝-->
                                                            <div class="col-md-12"
                                                                 style="margin:5px 0px 0px 0px;"></div>
                                                            <!-- 토탈 폼 시작-->
                                                            ...
                                                            <!-- 토탈폼 끝-->
                                                            <div class="col-md-12"
                                                                 style="margin:0px 0px 35px 0px;"></div>
                                                            ...
                                                            <div class="actions" style="text-align: right;">
                                                                  ...
                                                                  <span class="pro-buy-no">
                                                                        <button type="button"
                                                                                class="buynow btn btn-purple waves-effect waves-light">Buy Now
                                                                        </button>
                                                                  </span>
                                                            </div>
                                                            <?
                                                      ...
                                                      if ($db_goodsArr[0]["goods_opt_type"] == "0") {
                                                            ...
                                                            <div class="actions" style="text-align: right;">
                                                                  <span class="pro-add-to-cart">
                                                                              <button type="button" class="addbasket btn btn-danger waves-effect waves-light"
                                                      ...
                                                      ?>
                                                      <div class="actions product-wish-compare"
                        ...
                        <div class="col-md-12">
                              <div class="review-wrapper">
                                    <ul class="review-menu">
                                          <li class="active">
                                                <a data-toggle="tab" href="#pr-description">description</a>
                                          </li>
                                          <li>
                                                <a data-toggle="tab" href="#pr-reviews">reviews(1)</a>
                                          </li>
                                    </ul>
                                    <div class="con tab-content">
                                          ...
                                          <div id="pr-reviews" class="tab-pane fade">
                                                ...
                                                <div class="product-comment">
                                                      <h2>1 review for Aenean eu tristique</h2>
                                                      <div class="comment-a">
                                                            ...
                                                            <div class="comment-text">
                                                                  ...
                                                                  <div class="pro-com-des">
                                                                        <p>
                                                                              Lorem et placerat
                                                                              vestibulum, metus nisi
                                                                              posuere nisl, in
                                                                              accumsan elit odio quis
                                                                              mi.
