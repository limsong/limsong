        ...
        <div id="main" style="width:100%;">
                ...
                <form name="brandForm" id="brandForm" method="post" target="action_frame"
                        ...
                        <dl id="readContent" class="readContent">
                                ...
                                <dt>옵션타입<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
                                        <label><input type="radio" class="op_type0" value="0" name="option_type" <? if($ou_goods_opt_type == "0") echo "checked"; else echo "disabled" ?> >옵션없음</label>
                                        <label><input type="radio" class="op_type1" value="1" name="option_type" <? if($ou_goods_opt_type == "1") echo "checked"; else echo "disabled" ?>>일반옵션</label>
                                        <label><input type="radio" class="op_type2" value="2" name="option_type" <? if($ou_goods_opt_type == "2") echo "checked"; else echo "disabled" ?>>가격선택옵션</label>
                                </dd>
                                <dt>상품명<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="goods_name" value="<?= @$ou_goods_name ?>" id="goods_name" class="inputItem"
                                                style="width:100%;"  /></dd>
                                <dt class="option_name <?=@$show?>">옵션명1<span class="fontCol">*</span></dt>
                                <dd class="inputDd option_name <?=@$show?>"><input type="text" name="opName1" value="<?=@$goods_option_name_opName1?>" id="opName1"
                                                class="inputItem goods_option_inp" style="width:100%;" <?=@$readonly?> />
                                </dd>
                                <dt class="option_name <?=@$show?>">옵션명2<span class="fontCol">*</span></dt>
                                <dd class="inputDd option_name <?=@$show?>"><input type="text" name="opName2" value="<?=@$goods_option_name_opName2?>" id="opName2"
                                                class="inputItem goods_option_inp" style="width:100%;" <?=@$readonly?> />
                                </dd>
                                <dt>시장가/정찰가<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="commonPrice" value="<?= @$goods_option_value_commonPrice ?>" id="commonPrice"
                                                class="inputItem goods_option_inp" style="width:100%;" <?=@$readonly?> />
                                </dd>
                                <dt>판매가격<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="sellPrice" value="<?= @$goods_option_value_sellPrice ?>" id="sellPrice"
                                                class="inputItem goods_option_inp" style="width:100%;" <?=@$readonly?> /></dd>
                                <dt>재고<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
                                        <input type="text" name="qta" value="<?= @$goods_option_value_quantity ?>" id="qta" class="inputItem goods_option_inp"
                                                style="width:91%;" <?=@$readonly?> />
                                        <input type="Button" class="memEleB DateBoxa <?=@$show?>" data="option1" value="상품 입력"/>
                                        <div id="qtBoxa"></div></dd>
                                <dt>배송정책</dt>
                                <dd class="inputDd">
                                        <label><INPUT type="radio" value="0" class="dlv_special" name="goods_dlv_special" <? if ($ou_goods_dlv_special == "0") { echo 'checked';} ?>>일반배송</label>
                                        <label><INPUT type="radio" value="1" class="dlv_special" name="goods_dlv_special" <? if ($ou_goods_dlv_special == "1") { echo 'checked';} ?>>별도배송 </label>
                                </dd>
                                <dt>배송비정책</dt>
                                <dd class="inputDd dlv_dd" style="height: 70px;">
                                        <div style="width:100%;float:left;">
                                                <ul class="goods_dlv_special0">
                                                        <li><label><INPUT type="radio" value="1" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="0" && $ou_goods_dlv_type == "1") { echo 'checked';} ?>>판매자 기본 배송정책 적용</label> </li>
                                                        <li><label><INPUT type="radio" value="2" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="0" && $ou_goods_dlv_type == "2") { echo 'checked';} ?>>무료</label> </li>
                                                        <li><label><INPUT type="radio" value="3" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="0" && $ou_goods_dlv_type == "3") { echo 'checked';} ?>>고정금액(선불)</label> </li>
                                                </ul>
                                                <ul class="goods_dlv_special1" >
                                                        <li><label><INPUT type="radio" value="1" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "1") { echo 'checked';} ?>> 무료</label> </li>
                                                        <li><label><INPUT type="radio" value="2" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "2") { echo 'checked';} ?>>고정금액(선불)</label> </li>
                                                        <li><label><INPUT type="radio" value="3" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "3") { echo 'checked';} ?>>착불</label> </li>
                                                        <li><label><INPUT type="radio" value="4" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "4") { echo 'checked';} ?>>주문금액별 차등</label> </li>
                                                        <li><label><INPUT type="radio" value="5" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "5") { echo 'checked';} ?>>무게별 차등</label> </li>
                                                        <li><label><INPUT type="radio" value="6" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "6") { echo 'checked';} ?>> 부피별 차등</label> </li>
                                                        <li><label><INPUT type="radio" value="7" name="goods_dlv_type" <? if ($ou_goods_dlv_special=="1" && $ou_goods_dlv_type == "7") { echo 'checked';} ?>> 수량비례</label> </li>
                                                </ul>
                                        </div>
                                </dd>
                                <dt>배송비</dt>
                                <dd class="inputDd">
                                        <label><span class="dlv_txt">판매자 기본 배송정책 적용: 고정금액(선불) / 배송료 : 2500원 / 지역할증 : 있음</span><input type="text" name="goods_dlv_fee" class="inputItem dlv_fee"><span class="dlv_won">원</span></label>
                                </dd>
                                <dt>세일</dt>
                                <dd class="inputDd"><input type="text" name="sb_sale" value="<?= $ou_sb_sale ?>" id="sb_sale" class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>간략설명</dt>
                                <dd class="inputDd"><input type="text" name="summary" value="<?= $ou_summary ?>" id="summary" class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>제조사</dt>
                                <dd class="inputDd"><input type="text" name="manufacture" value="<?= $ou_manufacture ?>" class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>원산지</dt>
                                <dd class="inputDd"><input type="text" name="orgin" value="<?= $ou_orgin ?>" id="orgin" class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>상품코드</dt>
                                <dd class="inputDd"><input type="text" name="goods_code" id="goods_code"
                                                class="inputItem wd100" readonly value="<?= $ou_goods_code ?>"/></dd>
                        </dl>
                        ...
                        <dl class="readContent dlbimg">
                                ...
                                <dt>대이미지<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addbigImage" data="dlbimg"/></a>
                                </dd>
                                <?
                                ...
                                while ($bimgRow = mysql_fetch_array($bimgResult)) {
                                        ...
                                        $arrImg = @getImageSize($brandImagesDir . $bImage);
                                        $img_width = $arrImg[0];
                                        $img_height = $arrImg[1];
                                        ...
                                        <dd class="inputDd">
                                                ...
                                                */
                                                ...
                                                <input type="button" value="이미지보기" imgwid="<?= $img_width ?>"
                                                        imghei="<?= $img_height ?>" imgsrc="<?= $img_src ?>"
                                                        class="memEleB"
                        ...
                        <dl class="readContent dlmimg">
                                <dt>중이미지<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addmdImage" data="dlmimg"/></a>
                                </dd>
                                <?
                                ...
                                while ($mimgRow = mysql_fetch_array($mimgResult)) {
                                        ?>
                                        <dt><span class="fontCol"></span></dt>
                                        <dd class="inputDd">
                                                <?
                                                $mImage = $mimgRow["ImageName"];
                                                $arrImg = @getImageSize($brandImagesDir . $mImage);
                                                $img_width = $arrImg[0];
                                                $img_height = $arrImg[1];
                        ...
                        <dl class="readContent dlsimg">
                                <dt>소이미지<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addsmImage" data="dlsimg"/></a>
                                </dd>
                                <?
                                ...
                                <dd class="inputDd">
                                        ...
                                        $arrImg = @getImageSize($brandImagesDir . $sImage);
                                        $img_width = $arrImg[0];
                                        $img_height = $arrImg[1];
                        ...
                        <dl class="readContent dltimg">
                                ...
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addthumImage" data="dltimg"/></a>
                                </dd>
                                <?
                                ...
                                while ($timgRow = mysql_fetch_array($timgResult)) {
                                        ...
                                        <dd class="inputDd">
                                                ...
                                                $arrImg = @getImageSize($brandImagesDir . $tImage);
                                                $img_width = $arrImg[0];
                                                $img_height = $arrImg[1];
                        ...
                        <dl class="readContent">
                                ...
                                <dd class="inputDd"
                                        style="background-color: #3a5795;padding-left:9px;height:17px;"></dd>
                                <dt>옵션명1<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="opName3" value="<?= $goods_option_opName1 ?>" id="opName3" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>옵션명2<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="opName4" value="<?= $goods_option_opName2 ?>" id="opName4" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>옵션값1<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="opValue1" value="<?= $goods_option_opValue1 ?>" id="opValue1" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>옵션값2<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" name="opValue2" value="<?= $goods_option_opValue2?>" id="opValue2" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>재고<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
                                        <input type="text" name="qt" value="<?= $goods_option_quantity ?>" id="qt" class="inputItem" readonly
                                                style="width:91%;"/>
                                        <input type="Button" class="memEleB DateBox" data="option2"
                                                style="display: inline;" value="상품 입력"/>
                                        <div id="qtBox"></div>
                                </dd>
                                <dt>상세정보</dt>
