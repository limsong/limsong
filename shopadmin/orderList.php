                ...
                <div id="total">
                        ...
                        <div id="left">
                                <ul id="x">
                                        ...
                                        <li class="ml10">
                                                <a href="orderList.php?delivery=N">입금대기중</a>
                                        </li>
                                        <li class="ml10">
                                                <a href="orderList.php?delivery=D">입금완료</a>
                                        </li>
                                        <li class="ml10">
                                                <a href="orderList.php?delivery=Y">배송준비중</a>
                                        </li>
                                        <li class="ml10">
                                                <a href="orderList.php?delivery=Y">배송중</a>
                                        </li>
                                        <li class="ml10">
                                                <a href="orderList.php?delivery=O">구매확정</a>
                                        </li>
                                ...
                                <div id="maninfo">
                                        <form name="orderListForm" method="post" action="orderListDelPost.php?page=<?= $page ?>&keyfield=<?= $keyfield ?>&key=<?= $key ?>" target="action_frame">
                                                <table align="center" width="100%" class="memberListTable" border="0" cellspacing="0" ellpadding="0">
                                                        <tr class="menuTr">
                                                                <th width="5%" height="30"><input type="checkbox" onclick="CheckAll(this.checked)" /></th>
                                                                <!--<th width="23%"></th>-->
                                                                <th width="14%">주문번호
                                                                        <br>
                                                                        주문일시
                                    ...
                                    -->
                                                        ...
                                                        ?>
                                                        <tr>
                                                                <td colspan="7" style="text-align: right;"> <input type="button" class="memEleB" value="일괄등록" ></td>
                                                        </tr>
                                                </table>
                                        </form>
                                </div>
