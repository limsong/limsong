                ...
                <ul id="x">
                    ...
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "1") echo "class='active'"; ?>
                            href="orderList.php?delivery=1">상품문의(<?=$count_pay_wait?>)
                        </a>
                    </li>
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "2") echo "class='active'"; ?>
                            href="orderList.php?delivery=2">사용후기
                        </a>
                    </li>
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "4") echo "class='active'"; ?>
                            href="orderList.php?delivery=4">FAQ
                        </a>
                    </li>
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "8") echo "class='active'"; ?>
                            href="orderList.php?delivery=8">1:1 상담 관리
                        </a>
                    </li>
                    ...
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "32_1") echo "class='active'"; ?>
                            href="orderList.php?delivery=32_1">공지사항
                        </a>
                    </li>
                    <li class="ml10">
                        <a <?php if ($ou_delivery == "128_4") echo "class='active'"; ?>
                            href="orderList.php?delivery=128_4">자유게시판
                        </a>
                    </li>
