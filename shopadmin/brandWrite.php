...
<div id="total">
        ...
        <div id="main" style="width: 100%;">
                ...
                <form name="brandForm" id="brandForm" method="post" action="brandPost.php" target="action_frame" enctype="multipart/form-data">
                        ...
                        <dl id="readContent" class="readContent">
                                ...
                                <dd class="inputDd">
                                        <label><input type="radio" value="0" name="option_type"
                                                        checked="checked">옵션없음</label>
                                        <label><input type="radio" value="1" name="option_type">일반옵션</label>
                                        <label><input type="radio" value="2" name="option_type">가격선택옵션</label>
                                </dd>
                                <dt>상품명<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" value="<?=@$goods_name?>"  name="goods_name" id="goods_name" class="inputItem" style="width:100%;"/></dd>
                                <!--
                            ...
                            -->
                                <dt class="option_name">옵션명1<span class="fontCol">*</span></dt>
                                <dd class="inputDd option_name"><input type="text" value="<?=@$goods_opName1?>" name="opName1" id="opName1"
                                                class="inputItem goods_option_inp" style="width:100%;"/>
                                </dd>
                                <dt class="option_name">옵션명2<span class="fontCol">*</span></dt>
                                <dd class="inputDd option_name"><input type="text" value="<?=@$goods_opName2?>" name="opName2" id="opName2"
                                                class="inputItem goods_option_inp" style="width:100%;"/>
                                </dd>
                                <dt>시장가/정찰가<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" value="<?=@$commonPrice?>" name="commonPrice" id="commonPrice"
                                                class="inputItem goods_option_inp" style="width:100%;"/></dd>
                                <dt>판매가격<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" value="<?=@$sellPrice?>" name="sellPrice" id="sellPrice"
                                                class="inputItem goods_option_inp" style="width:100%;"/></dd>
                                <dt>재고<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
                                        <input type="text" name="qta" value="<?=@$qta?>" id="qta" class="inputItem goods_option_inp"
                                                style="width:80%;"/>
                                ...
                                <dt>배송정책</dt>
                                <dd class="inputDd">
                                        <label><INPUT type="radio" value="0" class="dlv_special"
                                                        name="goods_dlv_special" checked>일반배송</label>
                                        <label><INPUT type="radio" value="1" class="dlv_special"
                                                        name="goods_dlv_special">별도배송 </label>
                                </dd>
                                <dt>배송비정책</dt>
                                <dd class="inputDd dlv_dd" style="height: 70px;">
                                        <div style="width:100%;float:left;">
                                                <ul class="goods_dlv_special0">
                                                        <li><label><INPUT type="radio" value="1" name="goods_dlv_type"
                                                                                checked="checked">판매자 기본 배송정책 적용</label>
                                                        </li>
                                                        <li><label><INPUT type="radio" value="2" name="goods_dlv_type">무료</label>
                                                        </li>
                                                        <li><label><INPUT type="radio" value="3" name="goods_dlv_type">고정금액(선불)</label>
                                                        </li>
                                                </ul>
                                                <ul class="goods_dlv_special1">
                                                        <li><label><INPUT type="radio" value="1" name="goods_dlv_type">
                                                                        무료</label></li>
                                                        <li><label><INPUT type="radio" value="2" name="goods_dlv_type">고정금액(선불)</label>
                                                        </li>
                                                        <li><label><INPUT type="radio" value="3" name="goods_dlv_type">착불</label>
                                                        </li>
                                                        <li><label><INPUT type="radio" value="4" name="goods_dlv_type">주문금액별
                                                                        차등</label></li>
                                                        <li><label><INPUT type="radio" value="5" name="goods_dlv_type">무게별
                                                                        차등</label></li>
                                                        <li><label><INPUT type="radio" value="6" name="goods_dlv_type">
                                                                        부피별 차등</label></li>
                                                        <li><label><INPUT type="radio" value="7" name="goods_dlv_type">
                                                                        수량비례</label></li>
                                                </ul>
                                        </div>
                                </dd>
                                <dt>배송비</dt>
                                <dd class="inputDd">
                                        <label><span class="dlv_txt">판매자 기본 배송정책 적용: 고정금액(선불) / 배송료 : 2500원 / 지역할증 : 있음</span><input
                                                        type="text" name="goods_dlv_fee" class="inputItem dlv_fee"><span
                                                        class="dlv_won">원</span></label>
                                </dd>
                                <dt>세일</dt>
                                <dd class="inputDd"><input type="text" name="sb_sale" id="sb_sale" class="inputItem"
                                                style="width:100%;"/></dd>
                                <!--
                                <dt>적립금</dt>
                            ...
                            -->
                                <dt>간략설명</dt>
                                <dd class="inputDd"><input type="text" name="summary" id="summary" class="inputItem"
                                                style="width:100%;"/></dd>
                                <!--
                                <dt>무게</dt>
                                ...
                                -->
                                <dt>제조사</dt>
                                <dd class="inputDd"><input type="text" name="manufacture" class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>원산지</dt>
                                <dd class="inputDd"><input type="text" name="orgin" id="orgin" class="inputItem"
                                                style="width:100%;"/></dd>
                                        ...
                                        <dd class="inputDd">
                                                <label>
                                                        <input type="checkbox" name="sp[]"
                                                                value="<?= $rows['name'] ?>"/>
                                                        <span><img src="<? echo $brandImagesWebDir . $rows['img']; ?>"/></span>
                                                </label>
                                        </dd>
                                        <?
                                }
                        ...
                        <dl class="readContent dlbimg">
                                ...
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addbigImage"
                                                        data="dlbimg"/></a><input
                                                type="file" name="bigImage[]" id="bigImage"
                                                class="inputItem fileHeight"/><input
                                                type="button" value="취소" class="fileClear memEleB" data="bigImage"/>
                                </dd>
                        </dl>
                        <dl class="readContent dlmimg">
                                ...
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addmdImage"
                                                        data="dlmimg"/></a><input
                                                type="file" name="mdImage[]" id="mdImage" class="inputItem fileHeight"/><input
                                                type="button" value="취소" class="fileClear memEleB" data="mdImage"/></dd>
                        </dl>
                        <dl class="readContent dlsimg">
                                <dt>소이미지<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
                                        <a href="#" style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addsmImage"
                                                        data="dlsimg"/></a><span><input
                                                        type="file" name="smImage[]" id="smImage"
                                                        class="inputItem fileHeight"/></span><input type="button"
                                                value="취소"
                                                class="fileClear memEleB"
                                                data="smImage"/>
                                </dd>
                        </dl>
                        <dl class="readContent dltimg">
                                ...
                                <dd class="inputDd"><a href="#"
                                                style="float:left;padding-top:2px;padding-right:3px;"><img
                                                        src="images/i_add.gif" class="addthumImage"
                                                        data="dltimg"/></a><input
                                                type="file" name="thumImage[]" id="thumImage"
                                                class="inputItem fileHeight"/><input
                                                type="button" value="취소" class="fileClear memEleB" data="smImage"/></dd>
                        </dl>
                        <dl class="readContent">
                                ...
                                <dd class="inputDd"><input type="text" value="<?=@$optionName1?>" name="opName3" id="opName3" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>옵션명2<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" value="<?=@$optionName2?>" name="opName4" id="opName4" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>옵션값1<span class="fontCol">*</span></dt>
                                <dd class="inputDd"><input type="text" value="<?=@$optionValue1?>" name="opValue1" id="opValue1" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <!--
                                <dt>옵션명2 [-로 구분]</dt>
                            ...
                            -->
                                ...
                                <dd class="inputDd"><input type="text" value="<?=@$optionValue2?>" name="opValue2" id="opValue2" readonly
                                                class="inputItem"
                                                style="width:100%;"/></dd>
                                <dt>재고<span class="fontCol">*</span></dt>
                                <dd class="inputDd">
        ...
        <iframe name="action_frame" width="100%" height="200" style="display:inline;background-color:#eee;;"></iframe>
</div>
