        ...
        while ($row = mysql_fetch_assoc($result)) {                 //연관 배열
            ...
            <tr class="contentTr">
                ...
                <td class="memId" style="padding-left:10px;">
                    <a href="noticeRead.php?number=<?= $ou_uid ?>&page=<?= $page ?> &keyfield=<?= $keyfield ?>&key=<?= $key ?>"><?= $ou_subject ?></a>
                </td>
...
<form name="searchForm" method="post" action="boardList.php?bbs_code=notice">
