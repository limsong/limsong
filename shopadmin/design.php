                ...
                <form name="bannerForm" id="bannerForm" method="post" target="action_frame" enctype="multipart/form-data">
                    ...
                    if (count($id1) > 0) {
                        ...
                        <dl class="readContent banner1">
                            ...
                            <dd class="inputDd">
                                <a href="#" style="float:left;padding-top:2px;padding-right:3px;">
                                    <img src="images/i_add.gif" class="addimg" data="banner1"/>
                                </a>
                            ...
                            for ($i = 0; $i < count($id1); $i++) {
                                ...
                                <dd>
                                    <input type="text" name="link[]" class="fileHeight" style="padding-left:37px;"/>
                                </dd>
                                <?
                            }
                            ?>
                        ...
                        <dl class="readContent banner1">
                            ...
                            <dd class="inputDd">
                                <span>
                                    <input style="margin-left:37px;" type="file" name="banner1[]" id="img1" class="inputItem fileHeight"/>
                                </span>
                                <input type="button" value="취소" class="fileClear memEleB"/>
                            </dd>
                        </dl>
                    ...
                    if (count($id2) > 0) {
                        ...
                        <dl class="readContent banner2">
                            ...
                            <dd class="inputDd">
                                <a href="#" style="float:left;padding-top:2px;padding-right:3px;">
                                    <img src="images/i_add.gif" class="addimg" data="banner2"/>
                                </a>
                                <span style="margin-top:3px;float:left;color:#3a5795;">( 620x396 ) *개수제한3개</span>
                            </dd>
                            <?
                        ...
                        <dl class="readContent banner2">
                            ...
                            <dd class="inputDd">
                                <span>
                                    <input style="margin-left:37px;" type="file" name="banner2[]" id="img2" class="inputItem fileHeight"/>
                                </span>
                                <input type="button" value="취소" class="fileClear memEleB"/>
                            </dd>
                        </dl>
                    ...
                    if (count($id3) > 0) {
                        ...
                        <dl class="readContent banner3">
                            ...
                            <dd class="inputDd">
                                <a href="#" style="float:left;padding-top:2px;padding-right:3px;">
                                    <img src="images/i_add.gif" class="addimg" data="banner3"/>
                                </a>
                                <span style="margin-top:3px;float:left;color:#3a5795;">(620x396 - 620x396 - 620x812 - 620x396 - 620x396 ) *개수제한5개</span>
                            </dd>
                            <?
                        ...
                        <dl class="readContent banner3">
                            ...
                            <dd class="inputDd">
                                <span>
                                    <input style="margin-left:37px;" type="file" name="banner3[]" id="img3" class="inputItem fileHeight"/>
                                </span>
                                <input type="button" value="취소" class="fileClear memEleB"/>
                            </dd>
                        </dl>
                    ...
                    if (count($id4) > 0) {
                        ...
                        <dl class="readContent banner4">
                            ...
                            <dd class="inputDd">
                                <a href="#" style="float:left;padding-top:2px;padding-right:3px;">
                                    <img src="images/i_add.gif" class="addimg" data="banner4"/>
                                </a>
                        ...
                        <dl class="readContent banner4">
                            ...
                            <dd class="inputDd">
                                <span>
                                    <input style="margin-left:37px;" type="file" name="banner4[]" id="img4" class="inputItem fileHeight"/>
                                </span>
                                <input type="button" value="취소" class="fileClear memEleB"/>
                            </dd>
                        </dl>
