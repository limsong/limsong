    ...
    <body>
        <div id="total">
            ...
            <div id="main" style="width:100%;">
                ...
                <form name="bannerForm" id="bannerForm" method="post" target="action_frame" action="designPost.php" enctype="multipart/form-data">
                    <dl class="readContent dltimg">
                        <dt style="background-color:#3a5795;color:white;">배너</dt>
                        <dd class="inputDd" style="background-color: #3a5795;padding-left:9px;height:17px;padding-top:4px;color:white;"></dd>
                    </dl>
                    <?
                        $id1=array();
                        $id2=array();
                        ...
                        $imgName3=array();
                        $imgName4=array();
                        $query = "SELECT id,imgName,type FROM banner order by id asc";
