			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-2">
					<div class="small-cat-menu">
                                                <h2><a href="shop.php?code1=02&name1=<?=urlencode($sortName)?>"><?=$sortName?></a></h2>
						<ul class="cat-menu-ul">
							<?
							$db->connect();
							$db->query("SELECT sortName,sortOrder FROM sortCodes WHERE uxCode='02' and umCode='00' ORDER BY sortOrder ASC");
				...
				<div class="col-md-9 col-lg-10 no-padding">
					<div class="hidden-xs hidden-sm hidden-md col-lg-3">
							...
							<p>
								<a href="shop.php?code1=02&name1=<?=urlencode($sortName_first.$sortName_last)?>"><img src="<? echo $brandImagesWebDir.$dbdata[11]["imgName"] ?>" alt=""></a>
							</p>
						</div>
					</div>
