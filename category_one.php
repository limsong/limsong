		...
		<div class="row">
			...
			<div class="col-md-3 col-lg-2">
				<div class="small-cat-menu">
					<h2><a href="shop.php?code1=01&name1=<?=urlencode($sortName)?>"><?=$sortName?></a></h2>
					<ul class="cat-menu-ul">
					<?
					$db->connect();
					$db->query("SELECT sortName,sortOrder FROM sortCodes WHERE uxCode='01' and umCode='00' ORDER BY sortOrder ASC");
			...
			<div class="col-md-9 col-lg-10 no-padding">
				<div class="hidden-xs hidden-md hidden-sm col-lg-3">
						...
						<p>
							<a href="shop.php?code1=01&name1=<?=urlencode($sortName_first.$sortName_last)?>"><img src="<? echo $brandImagesWebDir.$dbdata[10]["imgName"] ?>" alt=""></a>
						</p>
					</div>
				</div>
						...
						<div class="cat-carousel">
							...
							<div class="col-md-12 ">
								<div class="single-product">
									...
									<div class="prod-info">
										<h2 class="pro-name">
											<a href="item_view.php?code=<?=$value["goods_code"]?>&name1=<?=urlencode($sortName_first.$sortName_last)?>" style="float:left;width:100%;"><div class="zxx_text_overflow_6"><?=$value["goods_name"]?></div></a>
										</h2>
										<div class="rating">
