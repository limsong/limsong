                    ...
                    <div class="bread-crumb">
                        <ul>
                            ...
                            if ($name2 == "") {
                                ...
                                echo '<li class="bc-home"><a href="m_shop.php?code1=' . $code1 . '&name1=' . $name1 . '&name2=">' . $name1 . '</a></li>';
                                echo '<li>' . $name2 . '</li>';
                            }
                            ?>
                        </ul>
                        ...
                        <div class="shop-short-wrapper">
                            ...
                            <div class="orderby-wrapper">
                                <label>등록 제품 :
                                    <b><?= $total_record ?></b>
                                    개
                                    <span style="margin-left:25px;">정렬</span>
                                </label>
                                                ...
                                                <div class="cm4 no-padding" style="padding:0px 1px;">
                                                    <div class="single-product">
                                                        ...
                                                        <div class="product-image">
                                                            ...
                                                            ?>
                                                            <div class="show-img">
                                                                <a href="item_view.php?code=<?= $value[goods_code] ?>&name1=<?= $name1 ?>&name2=<?= $name2 ?>">
                                                                    <img
                                                                        src="<? echo $brandImagesWebDir . $db_upload_simages[0]["imageName"]; ?>"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <?
                                                            if ($db_upload_simages[1]["imageName"] != "") {
                                                                ...
                                                                <div class="hide-img">
                                                                    <a href="item_view.php?code=<?= $value[goods_code] ?>&name1=<?= $name1 ?>&name2=<?= $name2 ?>">
                                                                        <img
                                                                            src="<? echo $brandImagesWebDir . $db_upload_simages[1]["imageName"]; ?>"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                                <?
                                                        ...
                                                        <div class="prod-info">
                                                            <h2 class="pro-name">
                                                                <a href="item_view.php?code=<?= $value[goods_code] ?>&name1=<?= $name1 ?>&name2=<?= $name2 ?>">
                                                                    <div
                                                                        class="zxx_text_overflow_6"><?= $value["goods_name"] ?></div>
                                                                </a>
                                                            </h2>
                                                            <div class="price-box">
                                                                <div class="price">
                                                    ...
                                                    <div class="single-list-product">
                                                        <div class="col-sm-4 col-md-4 product-image">
                                                            ...
                                                            <div class="show-img">
                                                                <a href="item_view.php?code=<?= $value[goods_code] ?>&name1=<?= $name1 ?>&name2=<?= $name2 ?>">
                                                                    <img
                                                                        src="<? echo $brandImagesWebDir . $db_upload_mimages[0]["imageName"]; ?>"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <?
                                                            if ($db_upload_mimages[1]["imageName"] != "") {
                                                                ?>
                                                                <div class="hide-img">
                                                                    <a href="item_view.php?code=<?= $goods_code ?>&name1=<?= $name1 ?>&name2=<?= $name2 ?>">
                                                                        <img
                                                                            src="<? echo $brandImagesWebDir . $db_upload_mimages[0]["imageName"]; ?>"
                                                                            alt="">
                                                                    </a>
                                                            ...
                                                            <div class="prod-list-detail">
                                                                <div class="prod-info">
                                                                    ...
                                                                    <div class="price-box">
                                                                        <div class="price">
                                                                            <span>
                                                                                <i class="fa fa-krw"></i> <?= number_format($value["sellPrice"]) ?>
                                                                            </span>
                                                                        </div>
                                                                        <div class="old-price">
                                                                            <span>
                                                                                <i class="fa fa-krw"></i> <?= number_format($value["commonPrice"]) ?>
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="rating">
                                                                    ...
                                                                    <p class="prod-des">Lorem ipsum dolor sit amet,
                                                                        consectetur adipiscing elit. Nam fringilla augue
                                                                        nec est tristique auctor. Donec non est at
                                                                        libero vulputate rutrum. Morbi ornare lectus
                                                                        quis justo gravida semper. Nulla tellus mi,
                        ...
                        <div class="pagination-shop">
                            <nav class="woocommerce-pagination">
                                <ul class="page-numbers">
                                    ...
                                    if ($page > 1) {
                                        $bfPage = $page - 1;   //이전페이지
                                        echo '<li ><a href="m_shop.php?code1=' . $code1 . '&name1=' . $name1 . '&page=' . $bfPage . '" class="#"><i class="fa fa-angle-left"></i></a></li>';
                                    }
                                    for ($my_page = $first_page; $my_page <= $last_page; $my_page++) {                    //현재 페이지
                                        if ($page == $my_page) {
                                            echo '<li><a class="current" >' . $my_page . '</a></li>';
                                        } else {
                                            echo '<li><a href="m_shop.php?code1=' . $code1 . '&name1=' . $name1 . '&page=' . $my_page . '" class="#">' . $my_page . '</a></li>';
                                        }
                                    }
                                    if ($page < $total_page) {
                                        $nxPage = $page + 1;  //다음 페이지
                                        echo '<li><a href="m_shop.php?code1=' . $code1 . '&name1=' . $name1 . '&page=' . $nxPage . '" class="#"><i class="fa fa-angle-right"></i></a></li>';
                                    }
                                    ?>
                                </ul>
                            </nav>
