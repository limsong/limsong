...
<body class="home-1 checkout-page cart-page">
        ...
        <div class="checkout-area">
                <form id="form1" name="ini" method="post" action="" target="_blank" >
                                                        ...
                                                        <h3 class="col-md-12"
                                                            style="margin:0px;padding-left:0px;border-bottom:none;margin-top:20px;">
                                                                ...
                                                                <div style="font-size:12px;" class="col-md-9">
                                                                        ...
                                                                        <input type="radio" name="addr_type" class="addr_type" id="addr_type1"
                                                                               checked="checked">
                                                                        ...
                                                                        <tbody>
                                                                                <tr>
                                                                                        ...
                                                                                        <td>
                                                                                                ...
                                                                                                <input type="radio" name="paymethod" value="vbank" id="vbank"
                                                                                                       style="padding:0px 5px;">
