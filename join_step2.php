...
?>
	<body class="home-1 shop-page cart-page overflow-y">
		<!--[if lt IE 8]>
							...
							<div class="checkbox-form">
								...
								<div class="row">
									<div class="col-md-12 col-xs-12 no-padding">
										<div class="col-md-8 col-xs-7">
											<div class="checkout-form-list">
												<label>아이디 (4~12자 영문,숫자)<span class="required">*</span></label>
									...
									<div class="col-md-12 col-xs-12">
										<div class="checkout-form-list">
											<label>구주소</label>
											<input type="text" readonly name="add1" id="address" class="add1 postcodify_address" placeholder="">
										</div>
									</div>
									<div class="col-md-12 col-xs-12">
										<div class="checkout-form-list">
											<label>새주소</label>
											<input type="text" readonly name="add2" class="add2" placeholder="">
										</div>
									</div>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="checkout-form-list">
									...
									<div class="col-md-12 col-xs-12 no-padding">
										<div class="checkout-form-list col-md-4 col-xs-4">
